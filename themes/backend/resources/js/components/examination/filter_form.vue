<template>
    <div>
        ...
        <el-dialog :close-on-click-modal="false" width="40%" :show-close="false" title="Lọc danh sách khám bệnh "
            :destroy-on-close="true" :visible.sync="show_filter">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <el-form-item :label="$t('patient.label.birthday')" style="width: 100% !important;">
                            <el-date-picker style="width: 100% !important;" size="small" v-model="search_data.birthday"
                    ...
                    <div class="col-sm-6">
                        <el-form-item :label="$t('examination.label.started_at')" style="width: 100% !important;">
                            <el-date-picker style="width: 100% !important;" size="small" v-model="search_data.started_at"
                                type="daterange" value-format="yyyy-MM-dd" range-separator="-"
                                :start-placeholder="$t('user.label.from date')" :end-placeholder="$t('user.label.to date')">
                            </el-date-picker>
                        </el-form-item>
                    ...
                    <div class="col-sm-6">
                        <el-form-item :label="$t('examination.label.finished_at')" style="width: 100% !important;">
                            <el-date-picker style="width: 100% !important;" size="small" v-model="search_data.finished_at"
                                type="daterange" value-format="yyyy-MM-dd" range-separator="-"
                                :start-placeholder="$t('user.label.from date')" :end-placeholder="$t('user.label.to date')">
                            </el-date-picker>
                        </el-form-item>
                    ...
                    <div class="col-sm-6">
                        <el-form-item label="Chuẩn đoán">
                            <el-select v-model="search_data.disease_id" size="small" placeholder="Chọn chuẩn đoán"
                                filterable style="width: 100% !important">
                                <el-option v-for="item in list_disease" :key="'sex' + item.value" :label="item.display_text"
                                    :value="item.id">
                                </el-option>
                            </el-select>
                        </el-form-item>
                    ...
                    <div class="col-sm-6">
                        <el-form-item label="Nguồn dữ liệu">
                            <el-select v-model="search_data.from_source" size="small" placeholder="Chọn nguồn dữ liệu"
                                filterable style="width: 100% !important">
                                <el-option v-for="item in listSource" :key="'sex' + item.value" :label="item.label"
                                    :value="item.value">
                                </el-option>
                            </el-select>
                        </el-form-item>
...
export default {
    ...
    methods: {
        ...
        searchDisease() {
            ...
            window.axios
                .get(route("api.disease.index", properties))
                .then((response) => {
                    this.loading = false;

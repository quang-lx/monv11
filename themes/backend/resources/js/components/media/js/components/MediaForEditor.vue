            ...
            <div class="sc-table">
                ...
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <el-row>
                            <el-col :span="24">
                                <vue-dropzone ref="myVueDropzone" id="dropzone" :options="dropzoneOptions"  @vdropzone-file-added="vdropzoneFileAdded" @vdropzone-success="vdropzoneSuccess"></vue-dropzone>

                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row" style="margin-top: 10px">
                                    <div class="col-12">
                                        <el-breadcrumb separator="/" style="margin-bottom: 20px; cursor:pointer">
  ...
  export default {
    ...
    data() {
      return {
        ...
        dropzoneOptions: {
          ...
          url: route('api.media.store') + '?parent_id=' + (this.$route.query.folder_id ? this.$route.query.folder_id : 0),
          thumbnailWidth: 100,
          maxFilesize: 100,
    ...
    methods: {
      queryServer(customProperties) {
          console.log(route('api.media.store'))
        const properties = {

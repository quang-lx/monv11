                                ...
                                <div class="sc-table">
                                    ...
                                    <el-table :data="data" stripe style="width: 100%" ref="dataTable"
                                        ...
                                        <el-table-column prop="male_min_value" :label="$t('service.label.male_min_value')" width="150">
                                            <template slot-scope="scope">
                                                <span v-if="scope.row.is_edit">
                                                    <el-input-number :controls="false" v-model="scope.row.male_min_value" size="small"
                                        ...
                                        <el-table-column prop="male_max_value" :label="$t('service.label.male_max_value')" width="150">
                                            <template slot-scope="scope">
                                                <span v-if="scope.row.is_edit">
                                                    <el-input-number :controls="false" v-model="scope.row.male_max_value" size="small"
                                        ...
                                        <el-table-column prop="female_min_value" :label="$t('service.label.female_min_value')" width="150">
                                            <template slot-scope="scope">
                                                <span v-if="scope.row.is_edit">
                                                    <el-input-number :controls="false" v-model="scope.row.female_min_value" size="small"
                                        ...
                                        <el-table-column prop="female_max_value" :label="$t('service.label.female_max_value')" width="150">
                                            <template slot-scope="scope">
                                                <span v-if="scope.row.is_edit">
                                                    <el-input-number :controls="false" v-model="scope.row.female_max_value" size="small"
...
<path d="M4.5 20H6.5V22H4.5V20ZM8.5 20H10.5V22H8.5V20ZM12.5 20H14.5V22H12.5V20ZM14.5 0H2.5C1.96957 0 1.46086 0.210714 1.08579 0.585786C0.710714 0.960859 0.5 1.46957 0.5 2V16C0.5 16.5304 0.710714 17.0391 1.08579 17.4142C1.46086 17.7893 1.96957 18 2.5 18H16.5C17.6 18 18.5 17.1 18.5 16V4L14.5 0ZM16.5 16H2.5V2H13.67L16.5 4.83V16ZM9.5 9C7.84 9 6.5 10.34 6.5 12C6.5 13.66 7.84 15 9.5 15C11.16 15 12.5 13.66 12.5 12C12.5 10.34 11.16 9 9.5 9ZM3.5 3H12.5V7H3.5V3Z" fill="#6C757D"/>
</svg>
...
<path d="M18.7983 5.70998C18.7058 5.61728 18.5959 5.54373 18.4749 5.49355C18.3539 5.44337 18.2242 5.41754 18.0933 5.41754C17.9623 5.41754 17.8326 5.44337 17.7116 5.49355C17.5907 5.54373 17.4808 5.61728 17.3883 5.70998L12.4983 10.59L7.60827 5.69998C7.51569 5.6074 7.40578 5.53396 7.28481 5.48385C7.16385 5.43375 7.0342 5.40796 6.90327 5.40796C6.77234 5.40796 6.64269 5.43375 6.52173 5.48385C6.40076 5.53396 6.29085 5.6074 6.19827 5.69998C6.10569 5.79256 6.03225 5.90247 5.98214 6.02344C5.93204 6.1444 5.90625 6.27405 5.90625 6.40498C5.90625 6.53591 5.93204 6.66556 5.98214 6.78652C6.03225 6.90749 6.10569 7.0174 6.19827 7.10998L11.0883 12L6.19827 16.89C6.10569 16.9826 6.03225 17.0925 5.98214 17.2134C5.93204 17.3344 5.90625 17.464 5.90625 17.595C5.90625 17.7259 5.93204 17.8556 5.98214 17.9765C6.03225 18.0975 6.10569 18.2074 6.19827 18.3C6.29085 18.3926 6.40076 18.466 6.52173 18.5161C6.64269 18.5662 6.77234 18.592 6.90327 18.592C7.0342 18.592 7.16385 18.5662 7.28481 18.5161C7.40578 18.466 7.51569 18.3926 7.60827 18.3L12.4983 13.41L17.3883 18.3C17.4809 18.3926 17.5908 18.466 17.7117 18.5161C17.8327 18.5662 17.9623 18.592 18.0933 18.592C18.2242 18.592 18.3538 18.5662 18.4748 18.5161C18.5958 18.466 18.7057 18.3926 18.7983 18.3C18.8909 18.2074 18.9643 18.0975 19.0144 17.9765C19.0645 17.8556 19.0903 17.7259 19.0903 17.595C19.0903 17.464 19.0645 17.3344 19.0144 17.2134C18.9643 17.0925 18.8909 16.9826 18.7983 16.89L13.9083 12L18.7983 7.10998C19.1783 6.72998 19.1783 6.08998 18.7983 5.70998Z" fill="#FF0707"/>
                                                ...
                                                <span v-else>
                                                    <i class="el-icon-edit"   @click="editRow(scope.$index)" style = "cursor:pointer"></i>
                                                    <i class="el-icon-delete" @click="deleteRow(scope.$index)" style = "cursor:pointer; padding-left: 8px"></i>
                                                </span>

<template>
    <div>
        <div class="content-header">
            <div class="row ">
                <div class="col-12">
                    <span class="f-breadcrumb">{{ $t('service.label.title') }}</span>
                    <hr>
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row justify-content-between mb-2">
                    <div class="col-md-8   ">
                        <router-link :to="{ name: 'admin.service.create' }" class="f-action ">
...
export default {
    ...
    methods: {
        ...
        queryServer(customProperties) {
            ...
            window.axios.get(route('api.service.index', _.merge(properties, customProperties)))
                .then((response) => {
        ...
        onExport() {
            ...
            window.axios.post(route('api.service.exports'), properties)
                .then((response) => {
        ...
        onImportDevices(file) {
            ...
            axios
                .post(route('api.service.imports'), formData, {
                    headers: {

        ...
        >
            ...
            >
                <div class="row">
                    <div class="col-sm-6">
                        <el-form-item
                            :label="$t('patient.label.birthday')"
                    ...
                    <div class="col-sm-6">
                        ...
                        >
                            <el-select
                                v-model="search_data.service_type"
                                size="small"
                    ...
                    <div class="col-sm-6">
                        <el-form-item
                            :label="$t('patient.label.created_at')"
                            style="width: 100% !important"
                        >
                            <el-date-picker
                                style="width: 100% !important"
                    ...
                    <div class="col-sm-6">
                        <el-form-item label="Người chỉ định">
                            <el-select
                                v-model="search_data.created_by"
                                size="small"
                    ...
                    <div class="col-sm-6">
                        <el-form-item label="Nguồn dữ liệu">
                            <el-select
                                v-model="search_data.from_source"
                                size="small"
...
export default {
    ...
    methods: {
        changeService(data, checked, indeterminate) {
            this.search_data.service_id =
                this.$refs.tree_service.getCheckedKeys(true);
        },
        getServiceOptions() {
            const properties = {
                page: 1,
            ...
            window.axios
                .get(route("api.service.tree", properties))
                .then((response) => {
        ...
        getServiceType() {
            ...
            window.axios
                .get(route("api.servicetype.index", properties))
                .then((response) => {
        ...
        getService() {
            ...
            window.axios
                .get(route("api.service.index", properties))
                .then((response) => {
        ...
        getUser() {
            ...
            window.axios
                .get(route("api.users.index", properties))
                .then((response) => {

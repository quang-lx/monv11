<template>
    <div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="f-box-title  d-flex align-items-center">
                                    ...
                                    <span class="f-text-title pl-1 pr-2"> Kết quả khám</span>
                                    <div  v-if="examination_service.status == 3" @click="show_result_popup = true" class="ml-2" style="cursor:pointer">
        ...
        <el-dialog title="In kết quả" :visible.sync="show_result_popup" top="2vh">
            <div v-if="examination_service.pdf_link" style="max-height: 85vh !important; overflow: scroll">
            ...
            <span slot="footer" class="dialog-footer"  v-if="examination_service.pdf_link">
                <el-button type="primary" @click="downloadPdf" size="small">Tải xuống file PDF</el-button>
            </span>
        </el-dialog>
    </div>
    ...
    export default {
        ...
        methods: {
            ...
            downloadPdf() {
                ...
                downloadLink.href = this.examination_service.pdf_link;

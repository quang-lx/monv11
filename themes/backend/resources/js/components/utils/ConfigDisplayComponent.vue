<template>
    <el-drawer width="376px" :show-close="true" top="1vh" direction="rtl" size="23%" :destroy-on-close="true"
        @close="closePopup" :visible.sync="show_popup" custom-class="demo-drawer">
        <div class="demo-drawer__content">
                    ...
                    <draggable class="list-group" tag="ul" v-model="list" v-bind="dragOptions" :move="onMove"
                        ...
                        <transition-group type="transition" :name="'flip-list'">
                            <li class="list-group-item d-flex justify-content-between align-items-center"
                                v-for="element in list" :key="element.order">
                ...
                <div>
                    ...
                    <draggable element="span" v-model="list2" v-bind="dragOptions" :move="onMove">
                        <transition-group name="no" class="list-group" tag="ul">
                            <li class="list-group-item d-flex justify-content-between align-items-center"
                                v-for="element in list2" :key="element.order">
            ...
            <div class="demo-drawer__footer d-flex justify-content-end">
                <el-button size="small" @click="closePopup" :loading="loading">{{ $t('common.cancel') }}</el-button>
                <el-button size="small" type="primary" @click="onSubmitConfig" :loading="loading">{{ $t('common.accept')
                }}</el-button>
            </div>
        </div>

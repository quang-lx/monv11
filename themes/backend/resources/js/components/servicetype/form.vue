                    ...
                    <div class="col-md-6">
                        ...
                        <div class="float-left d-flex align-items-center">
                            <i class="el-icon-arrow-left f-icon-bound-breadcrumb mr-2"
                                @click="gotoPage({ name: 'admin.servicetype.index' })"></i>
                    ...
                    <div class="col-md-6">
                        <div class="float-right">
                            ...
                            <el-button type="primary" @click="onSubmit()" size="small" :loading="loading"
                                ...
                                {{ $route.params.servicetypeId ? $t('mon.button.update') : $t('mon.button.add') }}
                            </el-button>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <el-form :rules="formRules" ref="modelForm" :model="modelForm" label-position="top"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <el-form-item :label="$t('servicetype.label.name')" prop="name"
                                                :class="{ 'el-form-item is-error': form.errors.has('name') }">
                                                <el-input maxlength="255" v-model="modelForm.name" size="small"
                                                    placeholder="Nhập tên loại dịch vụ"></el-input>
                                        ...
                                        <div class="col-12">
                                            <el-form-item :label="$t('role.label.description')"
                                                ...
                                                <el-input v-model="modelForm.description" type="textarea" show-word-limit
                                                    placeholder="Nhập mô tả" :autosize="{ minRows: 2, maxRows: 10 }"
                                        ...
                                        <div class="col-md-6" v-if="$route.params.servicetypeId">
                                            <el-form-item :label="$t('patient.label.created_at')" prop="created_at"
                                                :class="{ 'el-form-item is-error': form.errors.has('created_at') }">
                                                <el-input disabled v-model="modelForm.created_at" size="small"></el-input>
                                            </el-form-item>
                                        </div>
                                        ...
                                        <div class="col-md-6" v-if="$route.params.servicetypeId">
                                            <el-form-item :label="$t('patient.label.created_by_info')"
                                                ...
                                                <el-input disabled v-model="modelForm.created_by_info"
                                                    size="small"></el-input>
                                            </el-form-item>
                                        </div>
                                    </div>

                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-6">
                        <div class="float-right">
                            <el-button size="small" class="btn btn-flat  btn-warning"
                                       v-if="modelForm.current_examination.status == 'done'"
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4" v-if="$route.params.patientId">
                                                    <el-form-item :label="$t('patient.label.label status')"
                                                                  prop="status"
                                                        ...
                                                        <el-input :disabled="$route.params.patientId"
                                                                  ...
                                                                  v-model="modelForm.current_examination.status_text"
                                                                  size="small"></el-input>
                                                    </el-form-item>
                                                </div>
                                            ...
                                            <div class="row" v-if="$route.params.patientId">
                                                <div class="col-md-4">
                                                    <el-form-item :label="$t('patient.label.created_at')"
                                                                  prop="created_at"
                                                ...
                                                <div class="col-md-4">
                                                    <el-form-item :label="$t('patient.label.created_by_info')"
                                                        ...
                                                        <el-input :disabled="$route.params.patientId"
                                                                  v-model="modelForm.created_by_info"
                                                                  size="small"></el-input>
                                                    </el-form-item>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <el-form-item :label="$t('patient.label.label data_sources')"
                                                        ...
                                                        <el-input :disabled="$route.params.patientId"
                                                                  v-model="modelForm.data_sources"
                                                                  size="small"></el-input>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <el-form-item :label="$t('patient.label.dependant')"
                                                                  prop="dependant"
                                                                  :class="{ 'el-form-item is-error': form.errors.has('dependant') }">
                                                        <el-input maxlength="255" v-model="modelForm.dependant"
                                                                  size="small"
                                                                  placeholder="Nhập họ và tên"></el-input>
                                                        <div class="el-form-item__error"
                                                             v-if="form.errors.has('dependant')"
                                                ...
                                                <div class="col-md-4">
                                                    <el-form-item :label="$t('patient.label.phone_dependant')"
                                                        ...
                                                        <el-input maxlength="255" v-model="modelForm.phone_dependant"
                                                                  size="small"
                                                                  placeholder="Nhập số điện thoại"></el-input>
                                                        <div class="el-form-item__error"

                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <el-form-item :label="$t('patient.label.sex')" prop="sex"
                                                                ...
                                                                <el-select v-model="modelForm.sex" placeholder="Chọn giới tính" disabled
                                                                           size="small">
                                                        ...
                                                        <div class="col-md-4">
                                                            <el-form-item :label="$t('patient.label.birthday')" prop="birthday"
                                                                ...
                                                                <el-date-picker v-model="modelForm.birthday" type="date" disabled
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <el-form-item :label="$t('patient.label.papers')" prop="papers"
                                                                ...
                                                                <el-input v-model="modelForm.papers" size="small" disabled
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <el-form-item :label="$t('patient.label.address')" prop="address"
                                                                ...
                                                                <el-input v-model="modelForm.address" size="small" disabled
                                                        ...
                                                        <div class="col-md-4"  >
                                                            <el-form-item :label="$t('patient.label.label status')" prop="status"
                                                                ...
                                                                <el-input disabled
                                                                          ...
                                                                          v-model="modelForm.status_text" size="small"></el-input>
                                                            </el-form-item>
                                                        </div>
                            ...
                            <div class="row"  >
                                <div class="col-md-4">
                                    <el-form-item :label="$t('examination.label.started_at')"
                                        ...
                                        <el-input v-model="examination_data.started_at" size="small"
                                                  disabled
                                        ></el-input>
                                        <div class="el-form-item__error"
                                ...
                                <div class="col-md-4">
                                    <el-form-item :label="$t('examination.label.finished_at')"
                                        ...
                                        <el-input v-model="examination_data.finished_at" size="small"
                                                  disabled
                                        ></el-input>
                                        <div class="el-form-item__error"
                                ...
                                <div class="col-md-4">
                                    <el-form-item :label="$t('examination.label.type')"
                                        ...
                                        <el-input v-model="examination_data.type" size="small"
                                                  disabled
                                        ></el-input>
                                        <div class="el-form-item__error"
...
<script>
    ...
    export default {
        props: {
            ...
            modelForm: {default: {}, Object},
            examination_data: {default: {}, Object},
        },

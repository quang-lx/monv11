                            ...
                            <div class="card-body">
                                <div class="sc-table">
                                    ...
                                    <el-table
                                        ...
                                        <el-table-column  prop="code"  :label="$t('device.label.code')" width="120"  > </el-table-column>

                                        <el-table-column  prop="name"  :label="$t('device.label.name')" > </el-table-column>
                                        <el-table-column  prop="type"  :label="$t('device.label.type')" width="150"  > </el-table-column>
                                        <el-table-column  prop="serial_number"  :label="$t('device.label.serial number')" width="150"  > </el-table-column>
                                        <el-table-column  prop="box"  :label="$t('device.label.box')" width="150"  > </el-table-column>
                                        <el-table-column  prop="status"  :label="$t('device.label.box')" width="150"  > </el-table-column>

    ...
    <div>
        ...
        <div class="row justify-content-between mb-2">
            ...
            <div class="col-md-6">
                ...
                <div class="float-sm-right d-flex flex-row f-action" @click="show_add_user_form = true"
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="sc-table">
                    ...
                    <el-table :data="currentUsers" stripe style="width: 100%" ref="dataTable"
                        ...
                        <el-table-column prop="actions" :label="$t('common.action')" width="100">
                            <template slot-scope="scope">
                                <i class="el-icon-close" style="cursor:pointer"
                                    @click="confirmRemoveUser(scope.row.id)"></i>
                            </template>
                        </el-table-column>
                    </el-table>
        ...
        <el-dialog :close-on-click-modal="false" :title="$t('role.label.add user title')"
            :visible.sync="show_add_user_form">

            <el-select v-model="user_selecteds" multiple filterable remote reserve-keyword
                :placeholder="$t('common.search')" :remote-method="remoteMethod" :loading="loading">

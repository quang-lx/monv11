<template>
    <div>
        <el-dialog width="40%" :show-close="true" :title="$t('user.label.import title')" :destroy-on-close="true"
            ...
            <div class="d-flex justify-content-end">
                ...
                <el-button size="small" type="primary" @click="onImportUsers">{{
                    $t("common.upload")
                }}</el-button>
            </div>
        </el-dialog>

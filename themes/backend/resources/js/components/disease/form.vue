                    ...
                    <div class="col-md-6">
                        ...
                        <div class="float-left d-flex align-items-center">
                            <i class="el-icon-arrow-left f-icon-bound-breadcrumb mr-2"
                                @click="gotoPage({ name: 'admin.disease.index' })"></i>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <el-form :rules="formRules" ref="modelForm" :model="modelForm" label-position="top"
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <el-form-item :label="$t('disease.label.describe')"
                                                :class="{ 'el-form-item is-error': form.errors.has('describe') }">
                                                <el-input v-model="modelForm.describe" type="textarea"
                                                    placeholder="Nhập mô tả"
                                                    :autosize="{ minRows: 5, maxRows: 30 }"></el-input>
                                                <div class="el-form-item__error" v-if="form.errors.has('describe')"
                                                    v-text="form.errors.first('describe')"></div>
                                            </el-form-item>
                                        </div>
                                    </div>

                                    <div class="row" v-if="this.$route.params.diseaseId">
                                        <div class="col-6">
                                            <el-form-item :label="$t('disease.label.created_at')" prop="created_at">
                                                <el-input :disabled="true" v-model="modelForm.created_at" size="small"></el-input>
                                            </el-form-item>
                                        </div>
                                        <div class="col-6">
                                            <el-form-item :label="$t('disease.label.created_by')" prop="created_by">
                                                <el-input :disabled="true" v-model="modelForm.created_by" size="small"></el-input>
                                            </el-form-item>
                                        </div>
                                    </div>
...
export default {
    ...
    methods: {
        ...
        onSubmit() {
            ...
            this.form.post(this.getRoute())
                .then((response) => {
                    ...
                    this.$router.push({ name: 'admin.disease.index' });
                })
                .catch((error) => {
        ...
        fetchData() {
            ...
            let routeUri = '';
            if (this.$route.params.diseaseId !== undefined) {
                this.loading = true;
                routeUri = route('api.disease.find', { disease: this.$route.params.diseaseId });
        ...
        getRoute() {
            if (this.$route.params.diseaseId !== undefined) {
                return route('api.disease.update', { disease: this.$route.params.diseaseId });
            }
            return route('api.disease.store');
        },

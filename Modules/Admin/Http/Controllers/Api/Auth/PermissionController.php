...
class PermissionController extends ApiController
{
    ...
    {
        $this->permissionRepository->create($request->only('name', 'guard_name','group','title','group_name'));
    ...
    {
        $this->permissionRepository->update($permission, $request->only('name', 'guard_name','group','title','group_name'));
